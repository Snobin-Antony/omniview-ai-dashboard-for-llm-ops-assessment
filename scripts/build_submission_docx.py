...
ASSETS = ROOT / "assets"
OUT = ROOT / "Technical Exercise_ AI-Forward Engineering.docx"
# If Word has the original open, write a new copy
ALT = ROOT / "Technical Exercise_ AI-Forward Engineering - FINAL.docx"
...
def build():
    ...
    heading(doc, "How to run the demo they can look at", 1)
    para(doc, "From the repo README: Docker Desktop, then scripts/setup.ps1, then API + worker + frontend (three terminals). Open http://localhost:5173")
    bullets(
        doc,
        [
    ...
    para(
        doc,
        "Related files in the repo: AGENTS.md, CLAUDE.md, plan.md, README.md, backend/tests/, assets/ screenshots and diagrams.",
    )
